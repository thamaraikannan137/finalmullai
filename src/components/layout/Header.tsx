...
export function Header() {
  ...
  function navClass(id: string) {
    ...
    return cn(
      "whitespace-nowrap rounded-lg px-[9px] py-1.5 text-xs no-underline transition-colors",
      isActive
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-[60] border-b border-border bg-white/85 backdrop-blur-[18px] backdrop-saturate-[160%]">
      <div className="container-site flex h-[66px] items-center justify-between gap-3.5 overflow-hidden px-[22px]">
        <Link
          href="/"
          className="flex min-w-0 items-center gap-[11px] whitespace-nowrap text-text no-underline"
        ...
        <nav
          className="mq-desknav hidden min-w-0 items-center gap-px rounded-xl border border-border bg-brand-muted p-[3px]"
          aria-label="Main"
        >
        ...
        <div className="flex shrink-0 items-center gap-2.5">
          ...
          <a
            ...
            className="mq-deskjoin hidden rounded-[10px] bg-brand px-[18px] py-2.5 text-[13px] font-semibold text-white no-underline transition-colors hover:bg-brand-dark"
          >
            {content.common.join}
          </a>
          <button
